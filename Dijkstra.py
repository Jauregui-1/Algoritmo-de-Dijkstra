    ...
    while cola_prioridad:
        ...
        for vecino, peso in grafo[nodo_actual].items():
            ...
            if distancia < distancias[vecino]:
                ...
                camino_corto[vecino] = nodo_actual  # Guarda el nodo anterior en el camino más corto
...
grafo = {
    'A': {'B': 4, 'C': 8,'D':2,'E':6},  # Nodo A conectado a B (4) y C (8)
    'B': {'C': 2, 'D': 6, 'E': 3},  # Nodo B conectado a C (2), D (6), E (3)
    'C': {'F': 9, 'D': 3},  # Nodo C conectado a F (9) y D (3)
    'D': {'E': 1, 'G': 4, 'H': 7},  # Nodo D conectado a E (1), G (4), H (7)
    'E': {'F': 5, 'H': 3},  # Nodo E conectado a F (5) y H (3)
    'F': {'I': 2},  # Nodo F conectado a I (2)
    'G': {'H': 1, 'J': 5},  # Nodo G conectado a H (1) y J (5)
    'H': {'I': 4, 'J': 6},  # Nodo H conectado a I (4) y J (6)
    'I': {'J': 3},  # Nodo I conectado a J (3)
    'J': {}  # Nodo J no tiene conexiones
}
